...
import addImg from "../../images/add5.jpg";
    ...
    return (
        <Box>
            ...
            <Box sx={{pl:{xs:0,sm:0}}}>
                ...
                <iframe width="100%" height="250px" src="https://www.youtube.com/embed/VPHGa09cFuE?autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </Typography> 
