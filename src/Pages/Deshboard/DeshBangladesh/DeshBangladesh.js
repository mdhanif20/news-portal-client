...
const DeshBangladesh = () => {
    ...
    //load theme
    useEffect(()=>{
        fetch("https://mynewsportal.investmentinsights360.com/news/bangladesh")
        .then(res=> res.json())
    ...
    return (
        ...
        <Box sx={{px:{xs:2,sm:3,md:5}}}>
            ...
            onClick={handleBookingOpen}
                ...
                variant="contained"> <AddIcon/> Add Bangladeshi News</Button>
            </p>
            </Box>
