...
const DeshEntertainment = () => {
    ...
    //load theme
    useEffect(()=>{
        fetch("https://gentle-dawn-20200.herokuapp.com/news/entertainment")
        .then(res=> res.json())
    ...
    return (
        ...
        <Box sx={{px:{xs:2,sm:3,md:5}}}>
            ...
            onClick={handleBookingOpen}
                ...
                variant="contained"> <AddIcon/> Add Entertainment News</Button>
            </p>
            </Box>
...
export default DeshEntertainment;